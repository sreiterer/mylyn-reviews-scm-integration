...
import org.eclipse.mylyn.reviews.ui.UpdateReviewTask;
	...
	public void createControl(Composite parent, FormToolkit toolkit) {
		...
		try {
			...
			if (reviews.size() > 0) {
				...
				setControl(new EditorSupport(new ReviewTaskEditorInput(model, reviews.get(0)), new ReviewSubmitHandler() {

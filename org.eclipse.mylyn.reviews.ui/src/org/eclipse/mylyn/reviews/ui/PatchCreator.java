...
public class PatchCreator implements IPatchCreator {
	...
	public Patch create() throws CoreException {
		try {
			...
			URL url = new URL(attribute.getMappedAttribute(TaskAttribute.ATTACHMENT_URL).getValue());
			...
			throw new CoreException(new Status(IStatus.ERROR, ReviewsUiPlugin.PLUGIN_ID,
	...
	public String toString() {
		return attribute.getMappedAttribute(TaskAttribute.ATTACHMENT_FILENAME).getValue();
	}

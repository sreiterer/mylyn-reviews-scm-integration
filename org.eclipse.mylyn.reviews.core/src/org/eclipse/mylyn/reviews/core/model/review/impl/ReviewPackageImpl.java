...
public class ReviewPackageImpl extends EPackageImpl implements ReviewPackage {
	 ...
	 * @generated
	 */
	public EAttribute getChangeset_Revision() {
	 ...
	 * @generated
	 */
	public EAttribute getChangeset_Projecturl() {
	...
	public void createPackageContents() {
		...
		changesetEClass = createEClass(CHANGESET);
		createEAttribute(changesetEClass, CHANGESET__REVISION);
		createEAttribute(changesetEClass, CHANGESET__PROJECTURL);
		createEAttribute(changesetEClass, CHANGESET__COMMENT);
	...
	public void initializePackageContents() {
		...
		changesetEClass.getESuperTypes().add(this.getScopeItem());
		...
		initEAttribute(getChangeset_Revision(), ecorePackage.getEString(), "revision", "", 0, 1, Changeset.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getChangeset_Projecturl(), ecorePackage.getEString(), "projecturl", null, 0, 1, Changeset.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

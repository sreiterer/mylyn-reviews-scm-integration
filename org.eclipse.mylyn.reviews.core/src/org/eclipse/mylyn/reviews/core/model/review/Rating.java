...
public enum Rating implements Enumerator {
	...
	/**
	 * The '<em><b>REASSIGNED</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #FAILED_VALUE
	 * @generated
	 * @ordered 
	 */
	REASSIGNED(0, "REASSIGNED", "REASSIGNED");
	...
	/**
	 * The '<em><b>REASSIGNED</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>REASSIGNED</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #REASSIGNED
	 ...
	 * @ordered
	 */
	public static final int REASSIGNED_VALUE = 0;
	...
	/** Get ratings that are visible in the view (ui).
	 * 
	 * @return Rating values that are visible in the view
	 */
	public static List<Rating> getVisibleRatings() {
		List<Rating> ratings = new ArrayList<Rating>();
		
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Rating result = VALUES_ARRAY[i];
			if (!result.getName().equals(REASSIGNED)) {
				ratings.add(result);
			}
		}

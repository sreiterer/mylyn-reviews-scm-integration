...
@XmlRootElement(name = "MappingsMap")
public class MappingsMap {
	@XmlElement(name = "Tupel", required = true)
    private final List<Tupel> tupel = new ArrayList<Tupel>();
	
    public List<Tupel> getTupel() {
        return this.tupel;
    }

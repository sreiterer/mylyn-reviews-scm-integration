...
/**
 * Message Bundle for review editor page.
 * 
 * @author Kilian Matt
...
public class Messages extends NLS {
	...
	public static String CreateReviewTaskEditorPart_ReviewItems;
	public static String CreateReviewTaskEditorPart_Create_Review;
	public static String CreateReviewTaskEditorPart_Header_Description;
	public static String CreateReviewTaskEditorPart_Header_Revision;
	...
	public static String createReviewTaskEditorPart_NoChangesetSelected_message;
	public static String createReviewTaskEditorPart_NoChangesetSelected_title;
	public static String createReviewTaskEditorPart_Select_Reviewer;
	public static String createReviewTaskEditorPart_Select_Reporter_message;
	public static String ReporterInputValidator_Error_Message;
	public static String EditorSupport_Original;
	public static String EditorSupport_Patched;
	public static String EditorSupport_Previous_Revision;
	...
	public static String ReviewSummaryTaskEditorPart_Header_Changesets;
	public static String ReviewSummaryTaskEditorPart_Partname;
	public static String ReviewTaskEditorInput_New_Review;
	public static String ReviewEditor_Perform_Review;
	...
	public static String ReviewTaskEditorPart_Header_Operation;
	public static String ReviewTaskEditorPart_Header_File;
	public static String ReviewEditor_Changesets;

	public static String ReviewEditor_Content;
	public static String CreateReviewTaskEditorPart_Reassign_Review;
	public static String createReviewTaskEditorPart_Select_Review;
	public static String createReviewTaskEditorPart_Select_Review_message;
	public static String ReassignChangesetInputValidator_Error_Message;
